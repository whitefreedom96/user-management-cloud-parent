package com.unicard.usermanagement.security.oauth2;
...
import com.unicard.usermanagement.exception.OAuth2AuthenticationProcessingException;
import com.unicard.usermanagement.dto.SocialProvider;
import com.unicard.usermanagement.service.UserService;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest oAuth2UserRequest) throws OAuth2AuthenticationException {
        ...
        try {
            ...
            if (provider.equals(SocialProvider.GITHUB.getProviderType())) {
                populateEmailAddressFromGitHub(oAuth2User, attributes);
            }
    ...
    public void populateEmailAddressFromLinkedIn(OAuth2UserRequest oAuth2UserRequest, Map<String, Object> attributes) throws OAuth2AuthenticationException {
       ...
       // attributes.put("name", oAuth2UserRequest.getAdditionalParameters());
    }

    public void populateEmailAddressFromGitHub(OAuth2User oAuth2User, Map<String, Object> attributes) throws OAuth2AuthenticationException {
        attributes.put("name", oAuth2User.getAttributes().get("login"));
    }
}